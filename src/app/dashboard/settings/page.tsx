...
import { LogOut, Trash2, ArrowUpRight, Zap, Crown } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const proUrl = process.env.NEXT_PUBLIC_LS_PRO_VARIANT_ID !== "a_configurer"
    ? `https://studypilote.lemonsqueezy.com/checkout/buy/${process.env.NEXT_PUBLIC_LS_PRO_VARIANT_ID}?checkout[email]=${encodeURIComponent(email ?? "")}`
    : "/pricing";
